    ...
    def predict(self, device_id: str, msg: str, timestamp: float,
        ...
        if results:
            ...
            try:
                ...
                # LLM スコアで confidence を補正（最上位のみ）
                _lf = (
                    _llm_result.scores.semantic    * 0.35 +
                    _llm_result.scores.interaction * 0.30 +
                    _llm_result.scores.trend       * 0.20 +
                    _llm_result.scores.volatility  * 0.15
                )
